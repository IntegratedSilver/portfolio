...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("a.d.l.c.rubio@gmail.com");
    setCopied(true);
  };
  return (
    <div
      ...
      style={{
        ...
        background:
          "linear-gradient(144deg, rgba(0,0,0,1) 8%, rgba(28,33,170,1) 58%, rgba(15,8,23,1) 85%)",
      }}
    >
